...
char NEWTRODIT_FS_FOUND_FILES[] = " files matching the search pattern.";
...
char NEWTRODIT_PROMPT_ALREADY_OPEN_TAB[] = "File already opened in another tab. Do you want to switch to it? (y/n)";
...
char NEWTRODIT_SYNTAX_HIGHLIGHTING_LOADED[] = "Syntax highlighting rules successfully loaded.";
...
char NEWTRODIT_LOADING_COMPARING_FILES[] = "Comparing files... This may take a while.";
