...
#define reset_color "\x1b[0m"
	...
	char **manual_buf = calloc(sizeof(char *), MANUAL_BUFFER_Y); // Allocate 1000 char pointers
	for (int i = 0; i < MANUAL_BUFFER_Y; ++i)
	{
		manual_buf[i] = calloc(MANUAL_BUFFER_X, sizeof(char)); // Allocate 1000 bytes for each string
	}
